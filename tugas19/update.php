...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($avatar['name']) {
        ...
        if ($avatar_error === 0) {
            ...
            $query = "UPDATE users SET nama='$nama', email='$email', phone='$phone', address='$address', password='$password',role='$role', avatar='$avatar_name' WHERE id='$id'";
        ...
        $query = "UPDATE users SET nama='$nama', email='$email', phone='$phone', address='$address', password='$password', role='$role' WHERE id='$id'";
        $result = mysqli_query($conn, $query);
